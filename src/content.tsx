      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          <section id="about" className="py-16 bg-grey-50">
            <div className="max-w-6xl mx-auto px-6 pl-40">
              <h2 className="text-3xl text-gray-700 font-bold text-left mb-12 flex items-center gap-4">
                About Me
          ...
          <section id="experience" className="py-16">
            <div className="max-w-6xl mx-auto px-50">
          ...
          <section id="contact" className="py-16">
            <div className="max-w-4xl mx-auto px-6 text-center">
              ...
              px-6 py-3 rounded-lg">
                ...
                <a href="tel:+353xxxxxxxxx" className="flex items-center gap-3 bg-white
             text-blue-600 px-6 py-3 rounded-lg transition-colors">
                  <Phone size={20} />
                  +353 876970892
                </a>
              </div>
